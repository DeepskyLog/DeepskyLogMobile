...
public class Observation extends SchemaElement implements IObservation {
     ...
     * @param filters Array of IFilter that might be linked from this observation
     * (as Filter is optional by XML Schema, this parameter can be <code>NULL</code>
     * if passed Observation Node has no <filter> subelement) 
     ...
     * (as Lens is optional by XML Schema, this parameter can be <code>NULL</code>
     * if passed Observation Node has no <lens> subelement) 
        ...
        if( children != null ) {
          if( children.getLength() == 1 ) {                   
            ...
            if( child != null ) {
              ...
              this.setSkyQuality(new SurfaceBrightness(Float.parseFloat(sqm), SurfaceBrightness.MAGS_SQR_ARC_SEC));                                        
            } else {
        ...
        if( children != null ) {
          if( children.getLength() == 1 ) {                   
            ...
            if( child != null ) {
              ...
              this.setSkyQuality(new SurfaceBrightness(Float.parseFloat(sqm), unit));                                        
            } else {
                throw new SchemaException("Problem while retrieving sky quality meter value of observation. ");                                       
            }
          } else if( children.getLength() > 1 ) {
	 ...
	 * and if its start date, target, observer and result list is equal
...
/*	public boolean equals(Object obj) {
	 ...
	 * Observation as child element.<br>
	 ...
	 * 
	 * @return The site of the observation, or 
     * <code>null</code> if the observation has no site
	 */	 
