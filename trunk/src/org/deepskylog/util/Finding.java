 ...
 * used by the subclasses of an de.lehmannet.om.IFinding.<br>
...
public abstract class Finding extends SchemaElement implements IFinding {
	...
	protected Finding(Node findingElement) throws SchemaException {
		...
		if ((xsiType != null) ) { //&& (this.getXSIType().equals(xsiType))) {  // Cannot do the second check any more as this will break loading of old 1.4 OD and DS elements 
			Element child = null;
     ...
     * The string describes the impressions the observer had during
     ...
     * The string should describe the impressions the observer had during
     * the observation of an object.
     * 
    ...
    // -------------------------------------------------------------------
	/**
	 * Returns the language in which this session is described as 
	 * ISO language string. E.g. de=German, fr=French, ...<br>
	 * Might return <code>null</code> if no
	 * language was set for this session.
	 * 
	 * @return Returns a ISO language code that represents the sessions  
	 * describtion language or <code>null</code> if
    ...
    // -------------------------------------------------------------------
	/**
	 * Sets the language in which this finding is described. String must 
	 * be given as ISO language string. E.g. de=German, fr=French, ...<br>
	 * 
    ...
    // -------------------------------------------------------------------
	/**
	 * Returns <code>true</code> if the target was seen with this finding
	 * or not. 
	 ...
	 * 
	 * @param seen <code>true</code> if the target was seen by the observer or
	 * <code>false</code> if the target was not seen
	 * @since 1.6
	 */ 	
     ...
     * The new Finding element will be added as child
     * element to an given parent element. 
     * All specialised subclasses may use this method to
     * create a Finding element under which they may store
     ...
     * 
     * @param parent The parent element for the Finding
     * @return Returns a Finding element which is a child 
     * of the given parent element.<br>
