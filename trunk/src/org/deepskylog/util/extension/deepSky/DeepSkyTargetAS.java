...
public class DeepSkyTargetAS extends DeepSkyTarget {
    ...
    // ------------------------------------------------------------------- 
    /**
     * Constructs a new instance of a DeepSkyTargetAS from a given DOM 
     * target Element.<br>
     ...
     */ 
    public DeepSkyTargetAS(Node targetElement, 
                           IObserver[] observers)
	...
	public Element addToXmlElement(Element element) {   
        ...
        Element e_DSTarget = super.createXmlDeepSkyTargetElement(element, DeepSkyTargetAS.XML_XSI_TYPE_VALUE);
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the position angle of the asterism.
