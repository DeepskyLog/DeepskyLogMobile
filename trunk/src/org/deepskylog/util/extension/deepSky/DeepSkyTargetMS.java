...
import org.deepskylog.util.SchemaElement;
import org.deepskylog.util.Target;
import org.deepskylog.util.ITargetContaining;
...
public class DeepSkyTargetMS extends Target implements ITargetContaining {
    ...
    // ------------------------------------------------------------------- 
    /**
     * Constructs a new instance of a DeepSkyTargetMS from a given DOM 
     * target Element.<br>
        ...
        if( children != null ) {
            if( children.getLength() > 0 ) {
            	...
            	if( !setComponentsResult) {            		
            		throw new SchemaException("DeepSkyTargetMS is unable to add TargetStars as components. (ID: " + super.getID() + ")");	
            	}
            } else if( children.getLength() < 3 ) {
                throw new SchemaException("DeepSkyTargetMS must have at least three component stars. (ID: " + super.getID() + ")");                        
            } 
        }            
    ...
    // -------------------------------------------------------------------
	/**
	 * Adds this DeepSkyTargetMS to a given parent XML DOM Element.
	 * The DeepSkyTargetMS element will be set as a child element of
	 * the passed element.
	 * 
	 * @param parent The parent element for this DeepSkyTargetMS
	 * @return Returns the element given as parameter with this 
	 * DeepSkyTargetMS as child element.<br>
	...
	public Element addToXmlElement(Element element) {
        ...
        // Add all components
        // Cannot use addAsLinkToXMLElement as we're dealing with unique ID links only here
    ...
    // -------------------------------------------------------------------
    /**
     * Returns a list with all components of this multiple star given
     * as unique ID link.<br>
    ...
    /**
     * Returns a list with all components of this multiple star given
     * as de.lehmannet.om.TargetStar.<br>
     * If you want to access all linked targets as unique ID (String) 
     * objects, call getComponents().<br>
     * 
     * @return A list with all components of this multiple star, as 
     *         de.lehmannet.om.TargetStar or an empty list if the 
     ...
     * The current list of component stars will be overwritten.
     * To add one or more component stars use addComponent(de.lehmannet.om.TargetStar),
     ...
     * de.lehmannet.om.TargetStar or java.lang.String
    ...
    public boolean setComponents(List newComponents) {
    	...
    	while( iterator.hasNext() ) {
    		...
    		if( current instanceof TargetStar ) {
    			...
    			System.err.println("DeepSkyTargetMS cannot add: " + current + " as component. Continue with next entry...");
    		}
    	}
     ...
     * The given list must contain at least three entries of type
     * de.lehmannet.TargetStar or java.lang.String in case getComponents() 
    ...
    // -------------------------------------------------------------------
    /**
     * Adds a new star to a given list of component stars. If 
     * getComponents() returns <code>null</code> you need to use 
     * setComponents(List) first, to initially add (at least three) component
     * stars.
     * 
