...
import org.deepskylog.util.SurfaceBrightness;
import org.deepskylog.util.Target;
import org.deepskylog.util.util.SchemaException;


/**
 * DeepSkyTarget extends the de.lehmannet.om.Target class.
...
public abstract class DeepSkyTarget extends Target {
            ...
            if( children.getLength() == 1 ) {
                ...
                if(   (unit == null)
                   || ("".equals(unit))
                	...
                	unit = SurfaceBrightness.MAGS_SQR_ARC_MIN;  // Prio to 2.0 the value was always giben in mags per sqr args min
                }
                this.setSurfaceBrightness(new SurfaceBrightness(Float.parseFloat(surBright), unit));                               
            } else if( children.getLength() > 1 ) {
     ...
     *                 If <b>false</b> is returned the parameter had a 
     *                 negative value.
	 */
