...
/**
 * FindingVariableStar extends the de.lehmannet.om.Finding class.
 * Its specialised for variable star observations and their findings.
 * The class is mostly oriented after the recommondations of the
 * german "AAVSO - American Association of Variable Star Observers" 
...
public class FindingVariableStar extends Finding {
	...
	// Constant for XML representation: finding comment indicating whether this finding was already exported
	...
	// This should be the latest date you see anywhere on the chart, entered as YYMMDD. 
	...
	public FindingVariableStar(Node findingElement) throws SchemaException {
		...
		if ((children == null) || (children.getLength() != 1)) {
			throw new SchemaException("FindingVariableStar must have exact one visual magnitude value. (ID=" + super.getID() + ")");
		}
		...
		if (child == null) {
			...
			try {
				this.setMagnitude(Float.parseFloat(visMag));
			} catch(NumberFormatException nfe) {
				throw new SchemaException("FindingVariableStar visual magnitude must be a numeric value. (ID=" + super.getID() + ")");	
			}
	        ...
	        if(   (ft != null)
	           && (!"".equals(ft.trim())) 
				...
				this.setMagnitudeFainterThan(new Boolean(ft).booleanValue());
			}			
	        ...
	        if(   (un != null)
	           && (!"".equals(un.trim())) 
				...
				this.setMagnitudeUncertain(new Boolean(un).booleanValue());
			}	        			
		}
		...
		if ((children == null) || (children.getLength() != 1)) {
			throw new SchemaException("FindingVariableStar must have exact one chart ID or date. (ID=" + super.getID() + ")");
		}
		child = (Element) children.item(0);
		String chartID = "";
		if (child == null) {
        	...
        	if(   (textElements != null)
        	   && (textElements.getLength() > 0) 
        		...
        		for(int te=0; te < textElements.getLength(); te++) {
        			chartID = chartID + textElements.item(te).getNodeValue();
        		}
    			//chartID = child.getFirstChild().getNodeValue();
    			this.setChartDate(chartID);                		
        	} 
	        ...
	        if(   (na != null)
	           && (!"".equals(na.trim())) 
				...
				this.setNonAAVSOchart(new Boolean(na).booleanValue());
			}			
		}		
		...
		if ((children == null) || (children.getLength() < 1)) {
			throw new SchemaException("FindingVariableStar must have at least one comparism star. (ID=" + super.getID() + ")");
		}		
		String currentCompStar = "";
			...
			if (child == null) {
	        	...
	        	if(   (textElements != null)
	        	   && (textElements.getLength() > 0) 
	        		...
	        		for(int te=0; te < textElements.getLength(); te++) {
	        			currentCompStar = currentCompStar + textElements.item(te).getNodeValue();
	        		}
					//currentCompStar = child.getFirstChild().getNodeValue();
					this.addComparismStar(currentCompStar);              		
	        	} 
			}						
		}
        ...
        if(   (bs != null)
           && (!"".equals(bs.trim())) 
			...
			this.setBrightSky(new Boolean(bs).booleanValue());
		}
        ...
        if(   (c != null)
           && (!"".equals(c.trim())) 
			...
			this.setClouds(new Boolean(c).booleanValue());
		}
        ...
        if(   (cp != null)
           && (!"".equals(cp.trim())) 
			...
			this.setComparismSequenceProblem(new Boolean(cp).booleanValue());
		}
        ...
        if(   (fs != null)
           && (!"".equals(fs.trim())) 
			...
			this.setFaintStar(new Boolean(fs).booleanValue());
		}
        ...
        if(   (nh != null)
           && (!"".equals(nh.trim())) 
			...
			this.setNearHorizion(new Boolean(nh).booleanValue());
		}
        ...
        if(   (ob != null)
           && (!"".equals(ob.trim())) 
			...
			this.setOutburst(new Boolean(ob).booleanValue());
		}
        ...
        if(   (ps != null)
           && (!"".equals(ps.trim())) 
			...
			this.setPoorSeeing(new Boolean(ps).booleanValue());
		}
        ...
        if(   (si != null)
           && (!"".equals(si.trim())) 
			...
			this.setStarIdentificationUncertain(new Boolean(si).booleanValue());
		}        
        ...
        if(   (una != null)
           && (!"".equals(una.trim())) 
			...
			this.setUnusualActivity(new Boolean(una).booleanValue());
		}        	
	 ...
	 * Checks if this FindingVariableStar and the given Object are equal. Two FindingVariableStar
	 ...
	 * @return <code>true</code> if both Objects are instances from class FindingVariableStar,
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || !(obj instanceof FindingVariableStar)) {
			return false;
		}
	...
	// -------------------------------------------------------------------
	/**
	 * Adds this FindingVariableStar to an given parent XML DOM Element.
	 * The FindingVariableStar Element will be set as a child element of
	 * the passed Element.
	 * 
	 * @param parent The parent element for this FindingVariableStar
	 * @return Returns the Element given as parameter with this 
	 * FindingVariableStar as child Element.<br>
	...
	public Element addToXmlElement(Element parent) {
		...
		if( this.isNonAAVSOchart() ) {
			e_chart.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_NONAAVSOCHART,
					             Boolean.toString(this.isNonAAVSOchart()));	
		}		
		...
		if ( this.isBrightSky() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_BRIGHTSKY,
					               Boolean.toString(this.isBrightSky()));	
		}

		if ( this.isClouds() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_CLOUDS,
					               Boolean.toString(this.isClouds()));	
		}
		
		if ( this.isPoorSeeing() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_POORSEEING,
					               Boolean.toString(this.isPoorSeeing()));	
		}
		
		if ( this.isNearHorizion() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_NEARHORIZON,
					               Boolean.toString(this.isNearHorizion()));	
		}		
		...
		if ( this.isOutburst() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_OUTBURST,
					               Boolean.toString(this.isOutburst()));	
		}				
		...
		if ( this.isFaintStar() ) {
			e_Finding.setAttribute(XML_ELEMENT_FINDING_ATTRIBUTE_FAINTSTAR,
					               Boolean.toString(this.isFaintStar()));	
		}				
	...
	// ------------------------------------------------------------------------
	/**
	 * Returns true if magnitude value is the maximum seen magnitude
	 * during observation, and still the star itself couldn't be seen
	 * 
	 * @return true if magnitude value is the maximum seen magnitude
	 * during observation, and still the star itself couldn't be seen
	 */	
    ...
    // ------------------------------------------------------------------------
	/**
	 * Returns a list of comparism stars which were used to determin the
	 * stars magnitude
	 * 
    ...
    // ------------------------------------------------------------------------
	/**
	 * Returns the name or ID of a chart which was used to identify the star,
	 * and the comparism stars
	 * 
    ...
    // ------------------------------------------------------------------------
	/**
	 * Returns <code>true</code> if this finding was already exported to an
	 * AAVSO file before.<br>
	 * 
	 ...
	 * 
	 * @param exported A boolean value indicating whether this finding was
	 * already exported to an AAVSO file before
	 */
	 ...
	 * This should be the latest date you see anywhere on the chart, 
	 * entered as YYMMDD.<br> 
	 * If you do not see a date, use the first day of the copyright year 
	 * (Ex: "Copyright 2007" would be 070101).
	 * 
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if magnitude value is the maximum seen magnitude
	 * during observation, and still the star itself couldn't be seen
	 ...
	 * The given list must at least contain one entry. The list entries
	 * must be of type java.lang.String.
	 * The old List of comparism star magnitudes will be overwritten. If you want
	 * to add one or more comparism star magnitudes to the existing list use
	 * addAllComparismStarMagnitudes(java.util.List) or addComparismStarMagnitude(java.lang.String) instead.
	 * 
	...
	public void setComparismStars(List comparismStars) throws IllegalArgumentException {
		...
		if(   (comparismStars == null)
		   || (comparismStars.size() == 0)
		   ) {
	 ...
	 * 
	 * @param comparismStar A new comparism star which will be addded to the List
	 * of comparism star
	 * @return <b>true</b> if the new comparism star could be added,
	...
	public boolean addComparismStar(String comparismStar) {
		...
		if(   (comparismStar == null)
		   || ("".equals(comparismStar.trim()))
		   ) {
			return false;
		}
	 ...
	 * The old List of comparism stars will be extended by the new List
	 * of comparism stars. 
	 * 
	 * @param comparismStars A List of comparism star which will be added to
	 * the existing List of comparism star which is stored in the finding
    ...
    // ------------------------------------------------------------------------
	/**
	 * Returns true if the sky was bright or moon, twilight, light pollution
	 * or aurorae occured
	 * 
	 * @return true if the sky was bright or moon, twilight, light pollution
	 * or aurorae occured
	 */
    ...
    // ------------------------------------------------------------------------
	/**
	 * Set or unset if was bright or moon, twilight, light pollution
	 * or aurorae occured.
	 * Default value is <code>false</code>.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if there was a comparison sequence problem
	 * Default value is <code>false</code>.
	 */	
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if star was faint, near observing limit, only glimpsed.
	 * Default value is <code>false</code>.
	 */		
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if magnitude of star was uncertain
	 * Default value is <code>false</code>.
	 */			
    ...
    // ------------------------------------------------------------------------
	/**
	 * Returns true if star was near the horizon, low in the sky, in trees
	 * or the view was obstructed
	 * 
	 * @return true if star was near the horizon, low in the sky, in trees
	 * or the view was obstructed
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if star was near the horizon, low in the sky, in trees
	 * or the view was obstructed
	 * Default value is <code>false</code>.
	 */	
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unsetif the given chart is not a AAVSO chart
	 * Default value is <code>false</code>.
	 */		
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset in case of a star outburst
	 * Default value is <code>false</code>.
	 */	
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if seeing was poor
	 * Default value is <code>false</code>.
	 */
	...
	// ------------------------------------------------------------------------
	/**
	 * Set or unset if identification of star was uncertain
	 * Default value is <code>false</code>.
	 */	
	...
	// ------------------------------------------------------------------------
	/**
	 * Returns true star showed an unusual activity during observation like
	 * fading, flare, etc.
	 * 
	 * @return true star showed an unusual activity during observation like
	 * fading, flare, etc.
	 */
