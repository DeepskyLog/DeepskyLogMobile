 ...
 * (See: <a href="http://groups.google.com/group/openastronomylog">
 * XML Schema Doc</a>)
...
public interface IObservation extends ISchemaElement {
	 ...
	 * &lt;begin&gt;<code>Start date and time of observation</code>&lt;/begin&gt;
	 ...
	 * &lt;observation&gt;
	 * <br><i>More stuff goes here</i>
	 * &lt;accessories&gt;<code>Some accessories</code>&lt;/accessories&gt;
	 * <i>More stuff goes here</i>
	 * &lt;/observation&gt;
	 */
	 ...
	 * &lt;observation&gt;
	 * <br><i>More stuff goes here</i>
	 * &lt;end&gt;<code>End date and time of observation</code>&lt;/end&gt;
	 * <i>More stuff goes here</i>
	 * &lt;/observation&gt;
	 */
	 ...
	 * &lt;observation&gt;
	 * <br><i>More stuff goes here</i>
	 * &lt;faintestStar&gt;<code>Magnitude of faintest star</code>&lt;/faintestStar&gt;
	 * <i>More stuff goes here</i>
	 * &lt;/observation&gt;
	 */
	 ...
	 * &lt;observation&gt;
	 * <br><i>More stuff goes here</i>
	 * &lt;sqm&gt;<code>Sky quality in magnitudes per square arcsecond</code>&lt;/sqm&gt;
	 * <i>More stuff goes here</i>
	 * &lt;/observation&gt;
	 * @deprecated use XML_ELEMENT_MAGPERSQUAREARCSEC
	 */
	public static final String XML_ELEMENT_SKYQUALITY = "sqm"; 	
	 ...
	 * &lt;observation&gt;
	 * <br><i>More stuff goes here</i>
	 * &lt;sky-quality&gt;<code>Sky quality</code>&lt;/sky-quality&gt;
	 * <i>More stuff goes here</i>
	 * &lt;/observation&gt;
	 * @since 2.0
	 */
	public static final String XML_ELEMENT_SKYQUALITY_NEW = "sky-quality";			
     ...
     * &lt;observation&gt;
     * <br><i>More stuff goes here</i>
     * &lt;seeingType&gt;<code>Seeing during observation</code>&lt;/seeingType&gt;
     * <i>More stuff goes here</i>
     * &lt;/observation&gt;
     */
     ...
     * &lt;observation&gt;
     * <br><i>More stuff goes here</i>
     * &lt;magnification&gt;<code>Magnification used for observation</code>&lt;/magnification&gt;
     * <i>More stuff goes here</i>
     * &lt;/observation&gt;
     */
     ...
     * &lt;observation&gt;
     * <br><i>More stuff goes here</i>
     * &lt;image&gt;<code>Relative path to image</code>&lt;/image&gt;
     * <i>More stuff goes here</i>
     * &lt;/observation&gt;
     */
	 ...
	 * The observation Element will be set as a child element of
	 * the passed element.<br>
	 * Example:<br>
	 * &lt;parentElement&gt;<br>
	 * &lt;observation&gt;<br>
	 ...
	 * IObservation implementation as child element.
	 ...
	 * Might return <code>null</code> if no end date
	 * was given.
	 * 
	 * @return The end date of the observation or <code>null</code>
	 ...
	 * Might return <code>null</code> if no accessories
	 * have been used.
	 * 
	 * @return Accessories used for this observation or <code>null</code>
	 *         if no accessories were used
	 */	        
	...
	// -------------------------------------------------------------------
	/**
	 * Returns the eyepiece with which the observation
	 * was made.<br>
	 * Might return <code>null</code> if no eyepiece
	 * was used at all.
	 * 
	 * @return The eyepiece used for the observation or <code>null</code>
	 *         if no eyepiece was used.
	 */	 
    ...
    // -------------------------------------------------------------------    
	/**
	 * Returns the lens with which the observation
	 * was made.<br>
	 * Might return <code>null</code> if no lens
	 * was used at all.
	 * 
	 * @return The lens used for the observation or <code>null</code>
	 *         if no lens was used.
	 */	
    ...
    // -------------------------------------------------------------------    
	/**
	 * Returns the sky quality meter value 
	 * Might return <code>null</code> if no value was set at all.
	 * 
	 * @return The sky quality value, or
	 ...
	 * Might return <code>null</code> if no filter
	 * was used at all.
	 * 
	 * @return The filter used for the observation or <code>null</code>
	...
	// -------------------------------------------------------------------
	/**
	 * Returns the magnitude of the faintest star that could be
	 * seen during observation time with the unaided eye. 
	 * Might return <code>Float.NaN</code> if no value was set at all.
	 * 
    ...
    // -------------------------------------------------------------------    
    /**
     * Returns a list of images (relativ path to images), 
     * taken at this observation.
     ...
     * Values can reach from 1 to 5, where 1 is best seeing and
     * 5 the worst seeing.<br>
     * Might return <code>-1</code> if no value was set at all.
     * 
     * @return A int between 1-5 representing the seeing, or
     * <code>-1</code> if no value was set for seeing.
     */ 
	 ...
	 * Might return <code>null</code> if the observation was not
	 * made with any scope.
	 * 
	 ...
	 * Might return <code>null</code> if the observation is not
	 * part of any observation session.
	 * 
	 * @return The session this observation belongs to, or
	 * <code>null</code> if the observation does not belong
	 * to any session.
	 */	 
	 ...
	 * The old list of results will be overwritten. If
	 * you want to add one ore more results to the
	 * existing ones use addResults(java.util.List) or
	 * addResult(IFinding).<br>
	 * If the passed IFinding was successfully 
	 * attached to this observation, the method will
	 * return <b>true</b>. <br>
	 * If the passed IFinding is <code>null</code>,
	 * an IllegalArgumentException is thrown. 
	 * 
	 * @param results A new result for this observation
	 * @return <b>true</b> if the given result was successfully
	 * attached to this observation, while the old result list was deleted.
	 ...
	 * existing ones use addResults(java.util.List) or
	 * addResult(IFinding).<br>
	 * If the new list of results was successfully 
	 * attached to this observation, the method will
	 * return <b>true</b>. If one of the elements in the list
	 * does not implement the IFinding interface <b>false</b>
	 * is returned.<br> 
	 * If the new list is empty or <code>null</code>,
	 * an IllegalArgumentException is thrown. 
	 * 
	 * @param results The new list of results for this observation
	 * @return <b>true</b> if the given list was successfully
	 * attached to this observation. <b>false</b> if one of the new result elements
	 * in the list did not implement the the IFinding interface.
	 * @see de.lehmannet.om.IObservation#addResults(java.util.List results)
	 * @see de.lehmannet.om.IObservation#addResult(IFinding result)
	 * @see de.lehmannet.om.IFinding
	 ...
	 * The new list of results will be added to the 
	 * existing list of results belonging to this observation. 
	 * If you want to replace the old result list
	 * use setResults(java.util.List).<br>
	 * If the new list of results was successfully 
	 * added to the old result list, the method will
	 * return <b>true</b>. If the list is empty or <code>null</code>,
	 * the old result list will remain unchanged.
	 * 
	 * @param results A list with more results for this observation
	 * @return <b>true</b> if the given list was successfully
	 * added to this observations result list. <b>false</b> if the
	 * new list could not be added and the old list
	 * remains unchanged.
     ...
     * The new list of images will be added to the 
     * existing list of images belonging to this observation. 
     * If you want to replace the old images list
     * use setImages(java.util.List).<br>
     * If the new list of images was successfully 
     * added to the old images list, the method will
     * return <b>true</b>. If the list is empty or <code>null</code>,
     * the old result list will remain unchanged.
     * 
     * @param images A list (containing Strings) with additional images (path) for this observation
     * @return <b>true</b> if the given list was successfully
     * added to this observations images list. <b>false</b> if the
     * new list could not be added and the old list
     * remains unchanged.
     ...
     * The old list of images will be overwritten. If
     * you want to add one ore more images to the
     * existing ones use addImages(java.util.List) or
     * addImage(String).<br>
     * If the new list of images was successfully 
     * attached to this observation, the method will
     * return <b>true</b>. If one of the elements in the list
     * isn't a java.lang.String object <b>false</b>
     * is returned.<br> 
     * If the new list is empty or <code>null</code>,
     * an IllegalArgumentException is thrown. 
     * 
     ...
     * @return <b>true</b> if the given list was successfully
     * set to this observation. <b>false</b> if one of the lists elements wasn't a
     * String
	 ...
	 * The start date is a mandatory field, as the
	 * end date is not.
	 * 
	 * @param begin The start date of the observation
	 * @throws IllegalArgumentException if new begin date is <code>null</code>
	 */	    
    public void setBegin(java.util.Calendar begin) throws IllegalArgumentException;


	// -------------------------------------------------------------------
	/**
	 * Sets the end date of the observation.<br>
	 * The end date is an optional field, as 
	 * for example old observations might not
	 ...
	 * If there was already an eyepiece attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * If there was already an lens attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * If there was already an filter attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * If there was already an accessories list attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	...
	// -------------------------------------------------------------------
	/**
	 * Sets the magnitude value of the faintest star which
	 * could be seen with the unaided eye during the observation.<br>
	 * If there was already a value set for this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 * @param faintestStar The faintestStar of the observation in
	 *        magnitude
	 */	 
    ...
    // -------------------------------------------------------------------    
    /**
     * Sets the sky quality meter value that was determined during
     * the observation.<br>
     * If there was already a value set for this
     * observation, the old one will be replaced with
     * the new one. 
     ...
     * observation, the old one will be replaced with
     * the new one. 
     * In case a zoom eyepiece was used for the observation, this value
     * conatais th actual focalLength used. (And also the lens focal length
     * factor if used)<br>
     * Example:<br>
	 ...
	 * If there was already an observer attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * If there was already a scope attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * This observations start date must be between the 
	 * sessions start and end date.<br>
	 * If there was already a session attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 * @param session The session this observation belongs to
	 * @throws IllegalArgumentException if this observations start date
	 * is not between the session start and end date
	 */	
	 ...
	 * If there was already a site attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
	 ...
	 * If there was already a target attached to this
	 * observation, the old one will be replaced with
	 * the new one. 
	 * 
