...
public interface ISession extends ISchemaElement {
   ...
   * Example:<br>
   * &lt;session&gt; <br>
   * <i>More stuff goes here</i> &lt;coObserver&gt;<code>Sessions coObserver goes here</code>&lt;/coObserver&gt; <i>More
   ...
   * Since COMAST 1.5 it is possible to add a language description to a session element. This language description give
   * the language in which all session related entrys were made.<br>
   ...
   * @since 2.0
   */
  public org.w3c.dom.Element addAsLinkToXmlElement(org.w3c.dom.Element parent, boolean addElementToContainer);
   ...
   * @see org.w3c.dom.Element
   */
  public org.w3c.dom.Element addAsLinkToXmlElement(Element element);
