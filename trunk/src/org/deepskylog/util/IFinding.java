...
public interface IFinding extends ISchemaElement, IExtendableSchemaElement {
     ...
     * &lt;description&gt;<code>Finding description goes here</code>&lt;/description&gt;
	 ...
	 * Since COMAST 1.5 it is possible to add a language description to
	 * a finding element. This language description give the language
	 * in which all finding related entrys were made.<br>
     ...
     * @since 1.5
	 */
	public static final String XML_ELEMENT_ATTRIBUTE_LANGUAGE = "lang";    
     ...
     * The finding Element will be set as a child element of
     ...
     * IFinding implementation as child Element.
    ...
    // -------------------------------------------------------------------
	/**
	 * Returns the language in which this finding is described as 
	 * ISO language string. E.g. de=German, fr=French, ...<br>
	 * Might return <code>null</code> if no
	 * language was set for this finding.
	 * 
	 * @return Returns a ISO language code that represents the finding  
