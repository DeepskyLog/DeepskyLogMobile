...
public class DateConverter {
  ...
  public static double toJulianDate(Calendar gregorianCalendar) {
    ...
    double hourAndMinutes = day - 1 + ((double) (hour - tzOffset) / 24) + ((double) minute / 1440)
    ...
    // (DaysPerJulianYear + (Year + StartOfJulianCalendar)) + (DaysPerMonth * month + 1) + hoursAndMinutes +
    // leapYearOffset - 1524.5
    double julianDate = Math.round(365.25 * (year + 4716)) + Math.round(30.6001 * (month + 1)) + hourAndMinutes
        + leapYear - 1524.5;
