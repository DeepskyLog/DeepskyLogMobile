...
/**
 * The UIDGenerator implements the IIDGenerator
 * interface by using java.rmi.server.UID, which creates
 * pretty exact unique IDs.
 * 
...
public class UIDGenerator implements IIDGenerator {
	 ...
	 * 
	 * @return Returns a unique ID that can be used to identify 
