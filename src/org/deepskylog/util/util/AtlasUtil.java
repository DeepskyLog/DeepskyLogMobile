...
public class AtlasUtil {
	...
	private static final int DEC_BORDERS[] = new int[] { -900, -845, -725, -610,
		                                                 -500, -390, -280, -170, 
		                                                 -55, 55, 170, 280, 390, 
		                                                 500, 610, 725, 845, 900 };
	...
	private static final double DEC_BORDERS2000[] = new double[] { 84.5, 73.5, 62.0,
														       	  51.0, 40.0, 29.0, 17.0,
		                                                          5.5, 0.0, 0.0 };
	...
	public static int getMilleniumStarAtlasPage(EquPosition position) {
        ...
        if( dec >= 87 ) { 
            ...
            page = (int)((remain * (double) P_ZONE[zone]) / 8.) + 1 + (gore * 516);
