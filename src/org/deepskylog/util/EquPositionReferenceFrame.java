...
/**
 * EquPositionReferenceFrame describes the landscape in which
 * certain position values are valid.<br>
 * This class should be used by all instances of 
 * de.lehmannet.om.IPosition to describe in which
 * position reference frame their position values are valid. 
 * 
...
public class EquPositionReferenceFrame {
    ...
    // The EquPositionReferenceFrame origin (Valid values: geocentric or topocentric)
	 ...
	 */    
	public EquPositionReferenceFrame(String origin,
			  					     String equinox) throws IllegalArgumentException {
	 ...
	 * Checks if this EquPositionReferenceFrame and the given Object are equal. 
	 * The given object is equal with this EquPositionReferenceFrame, if its
	 * an instance from class EquPositionReferenceFrame and its 
	 * equinox date and the position origin are equal with this instances values.
	 * 
	 * @param obj The Object to compare this EquPositionReferenceFrame with.
	 * @return <code>true</code> if the given Object is an instance of EquPositionReferenceFrame
	...
	public boolean equals(Object obj) {
		...
		if(   obj == null
		   || !(obj instanceof EquPositionReferenceFrame)
		   ) {
			return false;
		}
     ...
     * The EquPositionReferenceFrame Element will be set as a child element of
     * the passed Element.
     * 
	 ...
	 * All valid origin values can be accessed by this classes
	 * constants.
	 * 
	 * @param origin The new origin of this position reference frame
	 * @throws IllegalArgumentException if origin was <code>null</code>
	 * or did not have valid value.
	 */
