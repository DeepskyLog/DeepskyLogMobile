...
public class DeepSkyTargetCG extends DeepSkyTarget {
    ...
    // ------------------------------------------------------------------- 
    /**
     * Constructs a new instance of a DeepSkyTargetCG from a given DOM 
     * target Element.<br>
     ...
     */ 
    public DeepSkyTargetCG(Node targetElement, 
                           IObserver[] observers)
        ...
        if( children != null ) {
            if( children.getLength() == 1 ) {
                ...
                this.setMagnitudeOf10thBrightestMember(Float.parseFloat(value));                         
     ...
     * 
     * @return The magnitude of the 10th brightest member in mag. 
     *         The returned value might be <code>Float.NaN</code> if the value was never set
     */
