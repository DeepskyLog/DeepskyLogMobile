...
package org.deepskylog.util.extension.imaging;
...
import org.deepskylog.util.Imager;
...
public class CCDImager extends Imager {
             ...
             if( child != null ) {
	        	...
	        	if(   (textElements != null)
	        	   && (textElements.getLength() > 0) 
	        		...
	        		float xS = Float.parseFloat(xSize);
	        		if( xS > 0.0 ) {
             ...
             if( child != null ) {
	        	...
	        	if(   (textElements != null)
	        	   && (textElements.getLength() > 0) 
	        		...
	        		float yS = Float.parseFloat(ySize);
	        		if( yS > 0.0 ) {
	 ...
	 * 
	 * @return Returns the pixel size on the x axis or Float.NaN if the
	 * value was never set
	 * @since 2.0
	 */ 
	 ...
	 * 
	 * @return Returns the pixel size on the y axis or Float.NaN if the
