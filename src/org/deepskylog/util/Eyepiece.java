 ...
 * An Eyepiece describes a optical eyepiece.
...
public class Eyepiece extends SchemaElement implements IEyepiece {
          ...
          if( children.getLength() == 1 ) {                   
             child = (Element)children.item(0);
              if( child != null ) {
                 ...
                 if( maxFL != null ) {
                   this.setMaxFocalLength(Float.parseFloat(maxFL));      
                 }
              } else {
	 ...
	 * Returns all fields of the class Eyepiece (unset field will be
	 ...
	 * object is equal with this Eyepiece, if its implementing IEyepiece 
	 * and its modelname, vendorname, focalLength and apparent field of
	 * view matches the values of this Eyepiece.
	 * @param obj The Object to compare this Eyepiece with.
	 * @return <code>true</code> if the given Object is an instance of IEyepiece
	 * and its modelname, vendorname, focalLength and apparent field of
	 * view matches with this Eyepiece.<br>
	 * @see java.lang.Object
	 */    
/*	public boolean equals(Object obj) {
        
		if(   obj == null
		   || !(obj instanceof IEyepiece)
		   ) {
			return false;
		}
     ...
     * ownerDocument if the passed boolean was <code>true</code>.
     * If the ownerDocument has no eyepiece container, it will
    ...
    /**
     * Adds the eyepiece link to an given XML DOM Element
     * The eyepiece element itself will <b>NOT</b> be attached to given elements 
	 ...
	 * If <code>null</code> is returned the apparent field of view value
	 * was never set.
	 ...
	 * of the eyepiece equals the amplification.<br>
	 * In case this eyepiece is a zoomEyepiece, this focal length is
	 * the minimum focal length. To retrieve the maximim focal length,
	 * please use getMaxFocalLength()
	 * 
    ...
    // -------------------------------------------------------------------
	/**
	 * Returns the maximal focal length of this eyepiece in case this
	 * eyepiece is a zoom eyepiece.
	 * Might return <code>Float.NaN</code> in case this eyepiece is not 
	 * a zoom eyepiece.
	 * 
	 ...
	 * Basically this method just checks if the maxFocalLength field is
	 * set.
	 * 
	 ...
	 * If Float.NaN is passed, this eyepiece will no longer be treated as
	 * a zoom eyepiece.
	 * 
