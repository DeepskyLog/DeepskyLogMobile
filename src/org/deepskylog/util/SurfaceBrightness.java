...
/**
 * Surface Brightness represents the value and the unit of a celestial
 * objects surface brightness
 * 
...
public class SurfaceBrightness {
    ...
    // -------------------------------------------------------------------
    /**
     * Constructs a new instance of Surface Brightness from a given DOM 
     * Element.<br>
     *
        ...
        if( unit != null ) {
            if(   (unit.equals(SurfaceBrightness.MAGS_SQR_ARC_MIN))
               || (unit.equals(SurfaceBrightness.MAGS_SQR_ARC_SEC))
                   ...
                   this.value = Float.parseFloat(sf.getFirstChild().getNodeValue());
                   this.unit = unit;           
            } else {
     ...
     * @throws IllegalArgumentException if unit parameter has unknown type.
     ...
     * Checks if this surface brightness and the given Object are equal. Two surface brightness'
     * are equal if both have the same value when represented as mags-per-squarearcsec.<br>
     * @param obj The Object to compare this surface brightness with.
     * @return <code>true</code> if both Objects are instances from class de.lehmannet.om.SurfaceBrightness and
     * their values in mags-per-squarearcsec is equal.
     * @see java.lang.Object
     */    
    public boolean equals(Object obj) {
        
        if(   obj == null
           || !(obj instanceof SurfaceBrightness)
           ) {
            return false;
        }
     ...
     * @return Returns the element given as parameter with this SurfaceBrightness value as
     * element value and this SurfaceBrightness unit as attribute
     ...
     * The returned value may be any float value (positiv or negativ).
     * If the passed unit is invalid, <code>Float.NaN</code> is returned.
     * @return This SurfaceBrightness value or <code>Float.NaN</code> if the
     * given unit parameter was invalid
     */             
     ...
     * Means, if the given string is equal to SurfaceBrightness.MAGS_SQR_ARC_MIN
     * or SurfaceBrightness.MAGS_SQR_ARC_SEC
    ...
    public static boolean isValidUnit(String unit) {
    	...
    	if(   (SurfaceBrightness.MAGS_SQR_ARC_MIN.equals(unit))
    	   || (SurfaceBrightness.MAGS_SQR_ARC_SEC.equals(unit))
    	) {
    		return true;
    	}
