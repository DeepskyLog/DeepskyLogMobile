...
public class Observers {
	...
	private static void askForRegistration() {
	    DslDialog.newInstance("ObserversDslDialogListener4", 
	...
	private static void askForLogin() {
	    DslDialog.newInstance("ObserversDslDialogListener3",
	...
	private static void askForUseOfCredentials() {
	    DslDialog.newInstance("ObserversDslDialogListener2",
	...
	private static void askForUseOfFirstRunTour() {
	    DslDialog.newInstance("ObserversDslDialogListener1",
